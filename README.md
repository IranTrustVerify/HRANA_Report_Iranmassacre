...
در عین حال، ما می‌پذیریم که سازمان‌های بشردوستانه ممکن است در برخی موارد با اطلاعات ناقص مواجه شوند یا خطاهایی در داده‌های گزارش‌شده رخ دهد. با این وجود، بر این باوریم که «جان ایرانی عزیز است» و بنابراین هیچ‌کس نباید بدون ارائه شواهد مستند، ادعاهای کلی و اثبات‌ نشده درباره گزارش‌های مربوط به جاویدنامان ایرانی مطرح کند.
